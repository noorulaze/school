        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {TEACHERS.map((slot) => (
              <div
                key={slot.id}
                className="bg-white rounded-2xl border border-[#e5e0d5] p-6 shadow-2xs hover:border-[#164e37] transition-all flex flex-col justify-between space-y-4"
              >
                <div className="space-y-4">
                  {/* Portrait Placeholder with Dignified Silhouette */}
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-xl bg-[#f4f1ea] border border-[#d2cabb] flex flex-col items-center justify-center shrink-0 text-[#164e37]">
                      <UserCheck className="w-8 h-8 text-[#164e37]" />
                    </div>

                    <div>
                      <span className="text-[10px] font-bold text-[#164e37] bg-[#f4f1ea] px-2.5 py-0.5 rounded border border-[#d2cabb]">
                  ...
                  <div className="p-3.5 bg-[#fbfaf7] rounded-xl border border-[#e5e0d5] text-xs space-y-1.5">
